(() => {
  ...
  const englishOrder = [
    'beyond-reasonable-doubt','priority-treatment','ephemeral-freedom','posthumous-truth','you-will-not-die-again','death-rehearsal','a-pessimistic-diagnosis','slow-and-steady','a-good-man','window-of-life','emotional-cleansing','self-scheduling','rebellious-death','the-rebellious-clock','journey-of-no-return','a-fortunate-mistake','identity-theft','ideal-love','the-only-woman','rest-in-peace','redemptive-big-bang','the-hammock-of-my-dreams','alternative-sin','unforgettable-past'
  ];
